...
╠➥  *Bio Bot* : ${ppstatus.status}\n║\n║*Support/Follow Me*\n║https://instagram.com/gilbert_situngkir09`, quoted: m, sendEphemeral: true, thumbnail: fs.readFileSync('./src/error.png'), contextInfo: { mentionedJid: [global.conn.user.jid]}})\n
╚══════════════════
}
