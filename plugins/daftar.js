...
let handler = async function (m, { text, usedPrefix }) {
  ...
  if (!Reg.test(text)) throw `Format salah!\nContoh: *${usedPrefix}daftar Gilbert|17*\nAtau: *${usedPrefix}daftar ${username}|Umur Lu`
