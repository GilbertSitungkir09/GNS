...
`.trim(), m.message, {
  ...
  async onCall(json) {
    ...
    await this.sendMessage(from, 'Kamu Terdeteksi Telah Menelpon Bot, Kamu Akan Di Blokir Otomatis!', MessageType.extendedText)
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: '『KHUSUS GILBERT』\n\nPerintah ini hanya dapat digunakan oleh _*Owner GNS!1!1! >_<*_!',
    mods: '『KHUSUS GILBERT』\n\nPerintah ini hanya dapat digunakan oleh _*Moderator*_ !',
    premium: '『KHUSUS PREMIUM』\n\nPerintah ini hanya untuk member _*Premium*_ !\n\n*Untuk Mengetahui List Premium Ketik #premium*\n*Atau Bisa Melihatnya di Info Wa GNS_BOT*',
